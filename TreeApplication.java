...
public class TreeApplication
{
	...
	public static final String INSTRUCTIONS_TEXT = "Click, drag, and release to start painting! Be patient, it takes a while!";
	...
	public static void main( String[] args )
	{
		...
		if (args.length > 0 && args[0].equals("seasons")) {
			...
			//guiFrame.add( new RecursiveTreeCollagePanel(INSTRUCTIONS_TEXT) );
			
		} else {
			
			// create a new JFrame to hold a single TreePainting
			guiFrame = new JFrame( "A Recrusive Awesome Tree Painting");
